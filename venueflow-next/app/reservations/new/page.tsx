      ...
      <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        ...
        {params?.created ? (
          <div className="mt-5 rounded-lg border border-emerald-200 bg-emerald-50 p-4 text-sm font-semibold text-emerald-800">
            Reservación creada correctamente con estatus pendiente.
          </div>
        ) : null}
        ...
        <form action={createReservation} className="mt-6 grid gap-5">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <label className="grid gap-2">
              ...
              <input
                name="title"
                required
                placeholder="Reunión de planeación"
            ...
            <label className="grid gap-2">
              <span className="text-sm font-bold text-slate-700">Asistentes</span>
              <input
                name="attendeesCount"
                required
                min={1}
          ...
          <label className="grid gap-2">
            ...
            <textarea
              name="description"
              rows={4}
              placeholder="Notas, recursos necesarios o contexto de la reserva."
      ...
      <aside className="space-y-4">
        <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <ul className="mt-4 space-y-3 text-sm text-slate-600">
            <li className="rounded-lg bg-slate-50 p-3">Capacidad máxima del espacio.</li>
            <li className="rounded-lg bg-slate-50 p-3">Fin posterior al inicio.</li>
            <li className="rounded-lg bg-slate-50 p-3">
              Bloqueo de traslapes pendientes o confirmados.
            </li>
          </ul>
        </section>

        <section className="rounded-xl border border-blue-100 bg-blue-50 p-5">
          <h2 className="text-lg font-black text-blue-950">Usuario demo</h2>
          <p className="mt-2 text-sm leading-6 text-blue-900">
            Mientras Auth.js llega en una fase posterior, las reservas se asocian a
